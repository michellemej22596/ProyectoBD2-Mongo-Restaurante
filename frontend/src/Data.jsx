...
import slideImg4 from './assets/slider-4.jpg';
...
export const homeSlide = [
  {
    img: slideImg1,
    title: 'Administra <span> tu menú </span> fácilmente',
    description:
      'Desde esta sección podrás visualizar y editar los platillos del restaurante para mantener el menú siempre actualizado.',
  },
  {
    img: slideImg2,
    title: 'Gestiona tus <span> ordenes en tiempo </span> real',
    description:
      'Consulta, edita y administra las órdenes de los clientes con facilidad y eficiencia desde un solo lugar.',
  },
  {
    img: slideImg3,
    title: 'Visualiza y edita <span> Restaurantes </span>',
    description:
      'Administra la información de los restaurantes registrados y realiza cambios cuando sea necesario.',
  },
  {
    img: slideImg4,
    title: 'Controla los <span> usuarios de la </span> plataforma',
    description:
      'Accede a la gestión de usuarios para ver perfiles, editar información o realizar cambios administrativos.',
  },
];
